...
namespace ds2xdriver
  {
  /// <summary>
  /// ds2pgsqlfns.cs: DVD Store 2 SQL Server Functions
  /// </summary>
...
//  
    public bool ds2connect()
      ...
      string sConnectionString = "Server=" + target_server +";Port=5432;User ID=web;Password=web;Database=ds2;MinPoolSize=8;MaxPoolSize=200;Timeout=1024;CommandTimeout=1200;ConnectionLifeTime=18000";
      try
        {
