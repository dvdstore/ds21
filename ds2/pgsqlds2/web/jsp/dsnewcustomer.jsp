<!-- 
dsnewcustomer.jsp JSP page that creates new user entry in ds database running on pgsql
...
if ( (firstname != "")&&(lastname != "")&&(address1 != "")&&(city != "")&&(country != "")&&(username != "")&&(password != "") )
  {
  try {Class.forName("org.postgresql.Driver");}                            // Connect to pgsql db
  ...
  if (check_username > 0)  // if username did exist in database already, print form again for retry
    ...
    String insert_newuser_query = "INSERT INTO CUSTOMERS (FIRSTNAME, LASTNAME, ADDRESS1, ADDRESS2, " + 
    ...
    Connection newuserconn = DriverManager.getConnection(jdbcURL); 
