ds2_create_orders_readme.txt


The data creation programs (ds2_create_orders.c, etc.) work best when compiled and run on Linux (or a Linux-like Windows 
environment such as Cygwin) due to the larger RAND_MAX. The Windows binaries (ds2_create_orders.exe, etc.) provided in the
...
(for ORDERS, ORDERLINES and CUST_HIST tables)
  ...
  compile ds2_create_orders.c (see compilation directions in program)
  sh ds2_create_orders_small.sh (or medium or large) 
