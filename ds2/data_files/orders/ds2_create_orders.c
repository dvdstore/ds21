...
/*
 * DVD Store 2 Create Order data - ds2_create_orders.c
 *
 ...
 * Syntax: ds2_create_orders n_first n_last filename S|M|L <i_month> n_Sys_Type n_Max_Prod_Id n_Max_Cust_Id
 *         (see details below)
 ...
 * To compile: gcc -o ds2_create_orders ds2_create_orders.c -lm
...
int main(int argc, char* argv[])
  ...
  //if (argc < 5)
    ...
    {
    fprintf(stderr, "Syntax: ds2_create_orders n_first n_last filename S|M|L <i_month> n_Sys_Type n_Max_Prod_Id n_Max_Cust_Id \n");     //Changed by GSK
    ...
    fprintf(stderr, "Examples: ds2_create_orders  1 1000 filename S 1 0 10000 20000 =>  orders        1 -> 1000\n");
    fprintf(stderr, "          ds2_create_orders    1 1M filename L 1 0 1000000 200000000 =>  orders        1 -> 1000000\n");
    fprintf(stderr, "          ds2_create_orders 1M+1 2M filename L 1 0 1000000 200000000 =>  orders  1000001 -> 2000000\n");
    exit(-1);
    }
  ...
  */
  ...
  for (i=n_first; i <= n_last; i++) 
	...
	sprintf(orderdate,"%4d/%02d/%02d", 2009, i_month, i_day_of_month);
