...
CREATE DATABASE DS2 ON 
  PRIMARY
    (
    NAME = 'primary', 
    FILENAME = '{DATAFILE_PATH}ds.mdf'             --Added a placeholder by GSK --This placeholder will be replaced by perl script with the paths given by user
    ),
...
go
bulk insert CUSTOMERS from '{DRIVELETTER}:\ds2\data_files\cust\us_cust.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUSTOMERS from '{DRIVELETTER}:\ds2\data_files\cust\row_cust.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
...
set dateformat ymd
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\jan_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\feb_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\mar_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\apr_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\may_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\jun_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\jul_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\aug_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\sep_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\oct_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\nov_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERS from '{DRIVELETTER}:\ds2\data_files\orders\dec_orders.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go

-- sqlserverds2_load_orderlines.sql

bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\jan_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\feb_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\mar_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\apr_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\may_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\jun_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\jul_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\aug_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\sep_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\oct_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\nov_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert ORDERLINES from '{DRIVELETTER}:\ds2\data_files\orders\dec_orderlines.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go

-- sqlserverds2_load_cust_hist.sql

bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\jan_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\feb_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\mar_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\apr_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\may_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\jun_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\jul_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\aug_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\sep_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\oct_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\nov_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go
bulk insert CUST_HIST from '{DRIVELETTER}:\ds2\data_files\orders\dec_cust_hist.csv' with (TABLOCK, FIELDTERMINATOR = ',')
go

-- sqlserverds2_load_prod.sql

bulk insert PRODUCTS from '{DRIVELETTER}:\ds2\data_files\prod\prod.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go

-- sqlserverds2_load_inv.sql

bulk insert INVENTORY from '{DRIVELETTER}:\ds2\data_files\prod\inv.csv' with (KEEPIDENTITY, TABLOCK, FIELDTERMINATOR = ',')
go
...
EXEC sp_fulltext_catalog  'FULLTEXTCAT_DSPROD', 'create', '{FULLTEXTCAT_PATH}'   --Added a placeholder by GSK
